...
namespace Work8Lesson30
{
    class Program
    {
        public static void Main()
        {
            ...
            var clone3 = (Mammal)prototype3.MyClone();
            Console.WriteLine($"{clone3.Name},{clone3.Legs}"); // Вывод:

            var prototype4 = new Cat("Муся", true, 4, 9);
